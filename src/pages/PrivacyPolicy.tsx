    ...
    <main className="min-h-screen bg-background px-4 py-10 sm:px-6">
      <article className="mx-auto max-w-3xl space-y-8">
        ...
        <section className="space-y-5 text-sm leading-7 text-muted-foreground">
          <div><h2 className="text-lg font-semibold text-foreground">Information we use</h2><p>Digimatt HR stores account, employment, attendance, leave, payroll, performance, and workplace records required to operate your organisation’s HR processes.</p></div>
